...
public class ScrollingActivity extends AppCompatActivity {
    ...
    private EditText edtPNom, edtAma, edtApa;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtApa = (EditText)findViewById(R.id.edtAPa);
        ...
        btncalcular.setOnClickListener(new View.OnClickListener() {
           @Override
            public void onClick(View v) {
               String curp = "nada";
               String apellido = edtApa.getText().toString();
               String vocal_ = "";
               try {
                   ...
                   {
                           if (apellido.substring(i, 1) == "a" || apellido.substring(i, 1) == "e"|| apellido.substring(i, 1) == "i"
                                   ||apellido.substring(i, 1) == "o" || apellido.substring(i, 1) == "u")
                           {
                                 vocal_ = apellido;}
                                 i = apellido.length();
                   }
                   curp = apellido.substring(0,1) + vocal_  + edtAma.getText().toString().substring(0,1) + edtPNom.getText().toString().substring(0,1) +
